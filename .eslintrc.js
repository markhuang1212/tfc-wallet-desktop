module.exports = {
  ...
  'settings': {
    'react': {
      ...
      'fragment': 'Fragment', // Fragment to use
      'version': 'detect', // React version. "detect" automatically
      // picks the version you have installed.
      // You can also use `16.0`, `16.3`, etc, if you want to override
      // the detected value.
